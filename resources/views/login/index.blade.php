        ...
        <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
          <div class="grid md:grid-cols-2 items-center gap-4 max-w-7xl w-full">
            <div class="border border-gray-300 rounded-md p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
              <form method="post" action="/login/store" class="space-y-6">
                @csrf
                <div class="mb-10">
                ...
                <div>
                    ...
                    <div class="relative flex items-center">
                      <input type="email" name="email" required class="w-full text-sm border border-gray-300 px-4 py-3 rounded-md outline-[#333]" placeholder="Enter user name" id="floatingInput"/>
                  ...
                  <div>
                    ...
                    <div class="relative flex items-center">
                      <input type="password" name="password" class="w-full text-sm border border-gray-300 px-4 py-3 rounded-md outline-[#333]" placeholder="Enter password" id="floatingPassword" />
                  ...
                  <div class="flex items-center justify-between gap-2">
                    <div class="flex items-center">
                      ...
                      <label for="remember-me" class="ml-0 block -mt-4 text-sm">
                        Belum memiliki akun? Silahkan <a href="/register" class="text-blue-600 hover:underline ml-1 whitespace-nowrap">Daftar</a>
                      </label>
                    </div>
                </div>
                <div class="!mt-10">
